...
def tans_img_rgb(img_A, ds_array_B, img_newB):
    ...
    ds_array_B_r[ds_array_B == 6] = 255
    ds_array_B_g[ds_array_B == 6] = 255
    ds_array_B_b[ds_array_B == 6] = 255  # 雪

    ds_array_B_r[ds_array_B == 5] = 100
    ds_array_B_g[ds_array_B == 5] = 100
    ds_array_B_b[ds_array_B == 5] = 100  # 浮土
...
def tans_img(img_ij,mask):
    ...
    ds_array_B_r[mask == 5] = 100
    ds_array_B_g[mask == 5] = 100
    ds_array_B_b[mask == 5] = 100  # 浮土

    ds_array_B_r[mask == 4] = 0
    ds_array_B_g[mask == 4] = 255
    ds_array_B_b[mask == 4] = 0  # 植被1

    ds_array_B_r[mask == 6] = 255
    ds_array_B_g[mask == 6] = 255
    ds_array_B_b[mask == 6] = 255  # 雪
    # ds_array_B_r[ds_array_B == 4] = 0  # 255,255,0粉砂
    # ds_array_B_g[ds_array_B == 4] = 255
    # ds_array_B_b[ds_array_B == 4] = 0
    img[:, :, 0] = ds_array_B_r
...
if __name__ == '__main__':
    ...
    model_path = 'D:/2022yanxing/20220920/sample/DeepLab_RGBD_best_model.pth'
