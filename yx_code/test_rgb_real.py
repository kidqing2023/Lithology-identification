...
row_cell = 5120
col_cell = 5120
NetName = 'unet'#unet，FCN8,DeepLab
CLASS_NUM = 7
...
def tans_img(img_ij,mask):
    ...
    ds_array_B_b[mask == 2] = 128  # 砂岩

    ds_array_B_r[mask == 3] = 240
    ds_array_B_g[mask == 3] = 116
    ds_array_B_b[mask == 3] = 0  # 砾岩
...
def identify_datu(image_name,dsm_name,model_path):
    ...
    if col > col_cell or row > row_cell:
        ...
        identify_single_img(image_name, model_path, CELL_X, CELL_Y)
...
if __name__ == '__main__':
    ...
    model_path = 'D:/2022yanxing/0527/unet_best_model.pth'
    # Uncertainty_Aware_Mean_Teacher_3_labeled
    # Fully_Supervised_3_labeled
    images_path = 'D:/2022yanxing/0526/unet/real_mask/dom'
    dsms_path= 'D:/2022yanxing/0526/unet/real_mask/dsm'
    row=256
    col=256
    timeall = 0
