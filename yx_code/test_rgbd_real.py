...
def identify_datu(image_name,dsm_name,model_path):
    ...
    output = os.path.dirname(image_name) + '/result/real' + os.path.basename(image_name).split('.')[0] + '.TIF'
...
if __name__ == '__main__':
    ...
    model_path = r'D:\2022_yx\0606\老师给的模型/DeepLab_RGBD_best_model.pth'
    # Uncertainty_Aware_Mean_Teacher_3_labeled
    # Fully_Supervised_3_labeled
    images_path = r'D:\2022yanxing\20220506\point1\point1_ceshi\dom'
    dsms_path= r'D:\2022yanxing\20220506\point1\point1_ceshi\dsm'
    row=256
    col=256
    timeall = 0
